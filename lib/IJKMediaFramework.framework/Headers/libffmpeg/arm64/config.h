...
#define FFMPEG_CONFIGURATION "--disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-videotoolbox --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=pcm_s16e --enable-decoder=flv --enable-decoder=h263 --enable-decoder=h263i --enable-decoder=h263p --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vp6 --enable-decoder=vp6a --enable-decoder=vp6f --enable-decoder=mjpeg --enable-decoder=mpjpeg --disable-hwaccels --disable-muxers --enable-muxer=mp4 --enable-muxer=pcm_s16le --disable-demuxers --enable-demuxer=pcm_s16le --enable-demuxer=rtsp --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=loas --enable-demuxer=m4v --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=mpjpeg --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=pcm_s16le --enable-parser=h263 --enable-parser=h264 --enable-bsfs --disable-bsf=mjpeg2jpeg --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=text2movsub --enable-protocols --disable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --enable-protocol=rtsp --enable-protocol=tcp --enable-protocol=udp --enable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=unix --enable-protocol=http --disable-devices --disable-filters --disable-iconv --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --enable-debug --enable-small --prefix=/Users/shenxing/Desktop/newIjkPlayer/ios/build/ffmpeg-arm64/output --enable-gpl --enable-libx264 --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=7.0 -I/Users/shenxing/Desktop/newIjkPlayer/ios/fat-x264/include' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=7.0 -I/Users/shenxing/Desktop/newIjkPlayer/ios/fat-x264/include' --extra-ldflags=' -arch arm64 -miphoneos-version-min=7.0 -L/Users/shenxing/Desktop/newIjkPlayer/ios/fat-x264/lib'"
